...
export default function AdminDashboard() {
  ...
  function printComanda(order: Order) {
    ...
    if (!w) return
    w.document.write(`<pre style="font:13px monospace;padding:16px;white-space:pre-wrap">
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
${order.marca === 'AREPA' ? '🫓 AREPA LOVERS' : '🍔 SMASH LOVERS'}
#${(order as any).numero_pedido} · ${new Date(order.fecha_orden).toLocaleTimeString('es-DO', {hour:'2-digit',minute:'2-digit'})}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
${user?.nombre}  ${user?.whatsapp}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
${items}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
